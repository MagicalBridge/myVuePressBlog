...
## 1125 灵感、复盘、记录
- 1、不要有情绪, 每个人都在完成自己分内的工作，这没有什么好说的。
- 2、当自己情绪不好的时候，应该起来走一下，或者直接学习点别的东西。
- 3、耐心完成工作，一项一项处理完毕。
- 4、耐心细致的梳理逻辑  key === endValue

## 1129 灵感、复盘、记录
- 1、能够掌控自己时间的人，能够掌控自己的命运。
- 2、只有在真实的业务场景中，才会暴露出问题，不断地解决问题才能成长。
- 3、
  - 感恩：感恩同事能和我一起解决问题，而不是丢下我一个人去处理问题。 
- 4、每天的读书时间又被压缩了。怎么抽时间看书呢？ 这是我思考的问题。
- 5、还是需要保证一周一篇文章的频率去写作。

## 1130 灵感、复盘、记录
- 1、对于UI来说，前端的布局是一个玄学。如何去解决这种问题，平常心去应对，一些反复修改的问题。
